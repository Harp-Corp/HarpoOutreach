...
struct QuickCampaignView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            // Step content
            if currentStep == 3 {
                // Step 3 braucht feste Hoehe fuer HSplitView/TextEditor – kein ScrollView
                stepReviewSend
                    .padding(24)
    ...
    // MARK: - Step 1: Prospecting (Companies + Contacts combined)
        ...
        VStack(alignment: .leading, spacing: 16) {
            HStack {
                ...
                VStack(alignment: .leading) {
                    Text("Prospecting")
                        .font(.headline)
                    Text("Suche nach Unternehmen und Kontakten in \(selectedIndustries.count) Branchen, \(selectedRegions.count) Regionen")
                        .font(.caption).foregroundStyle(.secondary)
                }
            }
            ...
            if isRunning {
                    ...
                    HStack {
                        ...
                        VStack(alignment: .leading, spacing: 2) {
                            Text("Prospecting abgeschlossen")
                                .font(.headline)
                            Text("\(companiesFound) Unternehmen, \(contactsFound) Kontakte gefunden")
                                .font(.caption).foregroundStyle(.secondary)
                        }
                    }
                }
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Klicke auf 'Weiter', um Unternehmen und Kontakte zu suchen")
                        .font(.callout).foregroundStyle(.secondary)
                    Text("Sucht automatisch nach Unternehmen und deren Compliance-Ansprechpartnern")
            ...
            HStack {
                ...
                VStack(alignment: .leading) {
                    Text("Emails erstellen")
                        .font(.headline)
                    Text("KI erstellt personalisierte Outreach-Emails für \(vm.leads.filter { ($0.emailVerified || $0.isManuallyCreated) && $0.draftedEmail == nil }.count) Kontakte")
                        .font(.caption).foregroundStyle(.secondary)
                }
            }
    ...
    private func advanceStep() {
        ...
        switch currentStep {
        case 0:
            // Step 0 -> Step 1: Prospecting (Companies + Contacts in einem Durchlauf)
        ...
        case 1:
            // Step 1 -> Step 2: Emails erstellen
